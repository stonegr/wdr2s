...
#git clone https://github.com/stonegr/small.git package/small
sed -i 'src-git openwrt-passwall https://github.com/xiaorouji/openwrt-passwall.git' feeds.conf.default
